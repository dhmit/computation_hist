...
export const looping_with_tix_demo_params = {
    ...
    instructions: [
        new Assembly_Line(['LXA', '5, 1'], "This example is relatively complicated, so you might want to read the" +
        ...
        new Assembly_Line("ADD 7".split(" "), "<code>ADD 7: </code> Adds the value at address 7 to the accumulator."),
        ...
        " press step?"),
        new Assembly_Line(['TIX', '2, 1, 1'], "<code>TIX 1, 1, 1: </code> The computer will compare the value of" +
